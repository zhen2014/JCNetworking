...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/gaozhenzhen/JCNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gaozhenzhen' => 'gaozhenzhen@51talk.com' }
  s.source           = { :git => 'https://github.com/gaozhenzhen/JCNetworking.git', :tag => s.version.to_s }
